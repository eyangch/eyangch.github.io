		...
		<div className="flex h-screen">
			<div className="flex flex-col m-auto sm:w-2xl w-sm sm:p-12 p-8 rounded-lg bg-blue-300">
				...
				<div className="mt-3 mb-3 text-wrap w-full">
					<p className="mt-4">
						Hello! I'm a rising sophomore at MIT, studying CS. This summer, I'm going to be in NYC working at <a className="underline" href="https://withtandem.com/">Tandem</a> as an Engineering Intern. My current interests revolve around low-level stuff, algorithms, ML, and any intersection of the three. 
					</p>
					<p className="mt-4">
